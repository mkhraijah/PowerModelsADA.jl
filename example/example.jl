...
data_area = solve_dopf_aladin_coordinated(data_14, model_type, optimizer; tol=1e-4, max_iteration=20, print_level=0, p=100, mu=1000, r_p=1.5, r_mu=2, q_gamma=0, sigma=sigma)
